...
type SportsClient interface {
	ListSportEvents(ctx context.Context, in *ListSportsEventRequest, opts ...grpc.CallOption) (*ListSportsEventResponse, error)
}
...
func (c *sportsClient) ListSportEvents(ctx context.Context, in *ListSportsEventRequest, opts ...grpc.CallOption) (*ListSportsEventResponse, error) {
	out := new(ListSportsEventResponse)
	err := c.cc.Invoke(ctx, "/sports.Sports/ListSportEvents", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SportsServer interface {
	ListSportEvents(context.Context, *ListSportsEventRequest) (*ListSportsEventResponse, error)
}
...
func (UnimplementedSportsServer) ListSportEvents(context.Context, *ListSportsEventRequest) (*ListSportsEventResponse, error) {
...
func _Sports_ListSportEvents_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/sports.Sports/ListSportEvents",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SportsServer).ListSportEvents(ctx, req.(*ListSportsEventRequest))
	}
